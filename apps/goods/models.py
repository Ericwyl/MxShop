...
class GoodsCategory(models.Model):
    ...
    name = models.CharField('类目名', default="", max_length=30, help_text="类别名")
...
class GoodsCategoryBrand(models.Model):
    ...
    desc = models.TextField("品牌描述", max_length=200, help_text="品牌描述")
...
class Goods(models.Model):
    ...
    sold_num = models.IntegerField("商品销售数量", default=0)
