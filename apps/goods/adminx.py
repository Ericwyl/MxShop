...
class GoodsCategoryAdmin(object):
    list_display = ["name", "category_type", "paranent_categpry", "add_time"]
    list_filter = ["category_type", "paranent_category", "name"]
    search_fields = ['name',]
...
class GoodsBrandAdmin(object):
    ...
    def get_context(self):
        ...
        if 'form' in context:
            context['form'].fields['category'].queryset = GoodsCategory.objects.filter(category_tepe=1)
        return context
